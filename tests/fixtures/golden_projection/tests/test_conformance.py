...
"""Architecture conformance tests for the Golden Proj projection."""
...
from ..state import GoldenProjState
...
class GoldenProjProvider(ProjectionConformanceProvider):
    def create_projection(self) -> Projection:
        return GoldenProjProjection()
...
class TestGoldenProjConformance:
    """Run the standard conformance suite against the GoldenProj projection."""

    def test_conformance_suite(self):
        projection = GoldenProjProjection()
        provider = GoldenProjProvider()
