# Projection Example (Golden Proj)
...
## What it does
The `GoldenProjProjection` consumes `TaskCreatedEvent` and `TaskCompletedEvent` facts from the event stream and materializes a queryable `GoldenProjState`.
