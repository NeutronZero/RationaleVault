"""RationaleVault Knowledge Citation — Explainable citation for knowledge retrieval results.

Mirrors the MemoryCitation pattern from rationalevault/memory/citation_builder.py.
...
class KnowledgeScore:
    ...
    Mirrors RetrievalScore from rationalevault/memory/ranking.py.
    """
    total: float
    confidence: float
...
class KnowledgeCitation:
    ...
    Mirrors MemoryCitation from rationalevault/memory/citation_builder.py.
    """
    knowledge_id: str
...
def compute_knowledge_score(
    ...
    Mirrors compute_retrieval_score from rationalevault/memory/ranking.py.
...
def build_knowledge_citation(
    ...
    Mirrors build_citation from rationalevault/memory/citation_builder.py.
    """
