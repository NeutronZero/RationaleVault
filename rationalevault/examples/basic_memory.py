"""RationaleVault built-in example: Basic Memory pipeline (Event -> Memory -> Retrieval).

This module is bundled inside the rationalevault package so it is importable
from anywhere the package is installed, regardless of working directory.
"""
...
def main() -> None:
    ...
    db_path = temp_dir / f"rv_example_memory_{uuid.uuid4().hex[:8]}.db"
