"""RationaleVault Compiler Registry — Lazy singleton registry for ContextPackageCompilers.
...
Usage:
    from rationalevault.compilers.registry import get_context_compiler, available_agents
