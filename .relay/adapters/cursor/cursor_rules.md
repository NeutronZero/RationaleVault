# Cursor Custom Rules Adapter
Generated from Relay Protocol config.
...
- Display warning alerts if attempting to modify files with open blockers.
- Render high-priority active tasks visually in the cursor sidebar if possible.
