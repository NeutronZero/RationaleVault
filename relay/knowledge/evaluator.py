"""Relay Knowledge Evaluator — Evaluates synthesized knowledge against ground truth.
...
from relay.knowledge.lineage import compute_provenance_depth
...
class KnowledgeEvaluator:
    ...
    def _evaluate_semantic(
        ...
        """
        from relay.evaluation.continuity_metrics import (
...
def _fuzzy_title_match(
    ...
    from relay.evaluation.continuity_metrics import get_jaccard_similarity
