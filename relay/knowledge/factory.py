"""Relay Knowledge Store Factory — Resolves the configured Knowledge Provider."""
from __future__ import annotations

from pathlib import Path

from relay.knowledge.store import BaseKnowledgeProvider, MarkdownKnowledgeProvider, SQLiteKnowledgeProvider
...
def get_knowledge_provider() -> BaseKnowledgeProvider:
    ...
    Defaults to MarkdownKnowledgeProvider inside .relay/knowledge.md.
    """
