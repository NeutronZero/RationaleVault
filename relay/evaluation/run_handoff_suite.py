...
from relay.evaluation.continuity_metrics import compute_metrics, MetricSummary
...
def save_reports(
    ...
    with open(md_path, "w", encoding="utf-8") as f:
        f.write(f"# Relay Scale & Stress Testing Report — Run {run_id}\n\n")
...
def run_knowledge_evaluation() -> dict[str, Any]:
    ...
    from relay.knowledge.evaluator import KnowledgeEvaluator, KnowledgeEvalResult, check_knowledge_gates, KnowledgeEvaluationThresholds
...
def main() -> None:
    ...
    cases_dir = project_root / "relay" / "evaluation" / "handoff_cases"
    reports_dir = project_root / "relay" / "evaluation" / "reports"
    ...
    for bench_result in knowledge_stats["benchmarks"]:
        from relay.knowledge.evaluator import KnowledgeEvalResult, check_knowledge_gates
