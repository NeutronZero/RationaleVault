"""Relay Context Evaluator — Evaluates context packages against benchmarks.
...
from relay.knowledge.context_compiler import ContextPackage, PROFILE_SOURCE_WEIGHTS
